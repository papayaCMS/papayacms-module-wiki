...
* @version $Id: base_wiki_parser.php 39732 2014-04-08 15:34:45Z weinert $
*/
...
* @subpackage Beta-Wiki
*/
class base_wiki_parser extends PapayaObject {
  /**
  ...
  */
  function getHighlightedCode($source, $lang) {
    if (!is_object($this->highlighter)) {
      $this->highlighter = $this->papaya()->plugins->get(
